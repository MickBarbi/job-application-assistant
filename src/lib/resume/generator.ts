...
export const SYSTEM_PROMPT = [
  ...
  "   employment dates, degrees, companies, project names, project tech stacks,",
  "   and project dates must match the master resume exactly.",
  "2. You MAY rephrase bullet points, reorder items by relevance to the job, and",
  "   select the most relevant skills, experience, projects, and leadership",
  "   entries. Preserve the JSON fields of the items you keep (including project",
  "   techStack/startDate/endDate and the leadership array).",
